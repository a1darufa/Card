...
class DonutShape: CAShapeLayer, ShapeLayerProtocol {
    required init(size: CGSize, fillColor: CGColor) {
        super.init()
...
//MARK: Back side shapes
class BackSideCirle: CAShapeLayer, ShapeLayerProtocol {
    required init(size: CGSize, fillColor: CGColor) {
        super.init()
...
extension ShapeLayerProtocol {
    init() {
        fatalError("int() can't be used to create an instance")
    }
}
